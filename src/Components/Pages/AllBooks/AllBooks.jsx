  ...
  return (
    <div>
      <select
        ...
        defaultValue='all'
      >
        <option value='all' className=''>All Books</option>
        <option value='available' className=''>Show Available Books</option>
      </select>
      <div className='grid grid-cols-1 md:grid-cols-4 container mx-auto py-10 gap-10'>
